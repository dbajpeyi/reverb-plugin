...
impl Plugin for Reverb {
    ...
    const EMAIL: &'static str = "dbajpeyi@gmail.com";
    ...
    fn process(
        ...
        self.reverb.set_dampening(0.8);
        self.reverb.set_wet(1.0);
        self.reverb.set_dry(0.5);
        self.reverb.set_room_size(0.8);
        for idx in 0..num_samples {
            let processed_out = self.reverb.process((outputs[0][idx], outputs[1][idx]));
            outputs[0][idx] = processed_out.0;
            outputs[1][idx] = processed_out.1;
        }
